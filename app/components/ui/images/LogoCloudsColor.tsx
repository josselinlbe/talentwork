        ...
        <div className="grid grid-cols-3 gap-8 md:grid-cols-3 lg:grid-cols-7">
          ...
          <div className="col-span-1 flex justify-center order-none">
            <a href="https://www.prisma.io/">
              ...
              <img className="h-14 object-cover hidden dark:block" src={LogoPrismaDark} alt="Remix" />
            </a>
          </div>
          <div className="col-span-1 flex justify-center order-first lg:order-none">
            <a href="https://remix.run/">
              <img className="h-14 object-cover dark:hidden" src={LogoRemix} alt="Remix" />
              <img className="h-14 object-cover hidden dark:block" src={LogoRemixDark} alt="Remix" />
            </a>
          </div>
          <div className="col-span-1 flex justify-center order-none">
          ...
          <div className="col-span-1 hidden lg:flex justify-center order-none">
