                              ...
                              <tr className=" text-gray-600">
                                <td className="px-2 py-2 whitespace-nowrap text-gray-700 text-sm">
                                  <div className="flex flex-col">
                                    <div>
                                      ...
                                      <span>
                                        {item.published ? (
                                          <span className="text-teal-500 text-xs">{/* ({t("blog.published")}) */}</span>
                                        ) : (
                                          <span className="text-red-500 text-xs">({t("blog.draft")})</span>
                                        )}
                                      </span>
                                    </div>
                                    <a href={"/blog/" + item.slug} target="_blank" rel="noreferrer" className="text-gray-400 underline">
                                      {item.slug}
                                    </a>
                                  </div>
                                </td>
                                ...
                                <td className="px-2 py-2 whitespace-nowrap text-xs">
                                  <div className="flex flex-col">
                                    <div className="">
                                      ...
                                      {item.readingTime && <span className="text-gray-400 italic">({item.readingTime})</span>}
                                    </div>
                                ...
                                <td>
                                  <div className="flex items-center space-x-2">
                                    <ButtonTertiary to={"/admin/blog/" + item.id}>{t("shared.edit")}</ButtonTertiary>
                                    <ButtonTertiary to={"/blog/" + item.slug} target="_blank">
                                      {t("shared.preview")}
                                    </ButtonTertiary>
                                  </div>
                                </td>
