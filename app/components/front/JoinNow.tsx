export default function JoinNow({ className }: { className: string }) {
  return (
          ...
          <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
              <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
                <span className="block">Download Starter kit</span>
              </h2>
              <p className="mt-4 text-lg leading-6 text-gray-100 dark:text-gray-400">Start building your own SaaS application.</p>
              <a
