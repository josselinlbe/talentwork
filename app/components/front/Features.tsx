...
const groups = [
  {
    ...
    items: [
      ...
      {
        name: "Entity Builder",
        description: "Create custom entities/properties that come with autogenerated views, forms, API, audit trails, and webhooks.",
      ...
      {
        name: "Workflows (IN CONSTRUCTION)",
        description: "Draft, Pending, and Done states, sending approval requests to custom tenant roles.",
        link: "/docs/features/workflows",
      },
      {
        name: "Documentation",
        description: "Write your documents for end-users or developers, just like on this site.",
        link: "/docs",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Postmark",
        description: "The email delivery service that people actually like.",
            ...
            <div className="mt-12 lg:mt-0 lg:col-span-2">
              <dl
                className={clsx(
                  ...
                  group.items.length <= 4 ? "sm:grid-rows-2" : "sm:grid-rows-6"
                )}
              >
