...
import { LinkWithWorkspacesAndContracts } from "~/utils/db/core/links.db.server";
                                ...
                                <div className="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                                  <div>
                                    <div className="flex items-end justify-between">
                                      <div className="text-sm truncate font-bold text-gray-900 flex-grow">{item.clientWorkspace.name}</div>
                                    </div>
                                  </div>
                              ...
                              return (
                                <tr key={idxClient}>
                                  <td className="px-3 py-2 whitespace-nowrap">
                                    <div className="text-sm font-extrabold text-gray-900">{item.clientWorkspace.name}</div>
                                  </td>
