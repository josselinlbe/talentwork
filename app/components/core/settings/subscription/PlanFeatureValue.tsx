    ...
    <div>
      {item ? (
        <div className="flex space-x-1 items-baseline">
          {item.type === SubscriptionFeatureLimitType.INCLUDED && <CheckIcon className="text-theme-500 text-center h-4 w-4" />}
          {item.type === SubscriptionFeatureLimitType.NOT_INCLUDED && <XIcon className="text-gray-300 text-center h-4 w-4" />}
