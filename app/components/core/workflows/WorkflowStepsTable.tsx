      ...
      <TableSimple
        ...
        headers={[
          ...
          },
          {
            ...
            formattedValue: (item) => <div className="cursor-not-allowed text-theme-600 font-medium">{item.action}</div>,
          },
          {
          ...
          },
          {
            ...
            formattedValue: (item) => (
              <div className="flex flex-col">
                ...
                <div className="font-normal italic text-xs text-gray-400">Under construction 🚧</div>
              </div>
            ),
          },
        ]}
