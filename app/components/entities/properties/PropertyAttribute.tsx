...
export default function PropertyAttribute({ name, title, value, setValue, className }: Props) {
  ...
  function isNumber() {
    return [PropertyAttributeName.Min, PropertyAttributeName.Max, PropertyAttributeName.MaxSize, PropertyAttributeName.Rows].includes(name);
  }
  function isBoolean() {
    return [PropertyAttributeName.Uppercase, PropertyAttributeName.Lowercase].includes(name);
  }
  function isSelector() {
