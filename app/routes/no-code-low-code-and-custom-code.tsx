...
export let loader: LoaderFunction = async ({ request }) => {
  ...
  const data: LoaderData = {
    title: `MVP to Enterprise | ${process.env.APP_NAME}`,
    i18n: translations,
  };
  return json(data);
};
...
export default function MVPToEnterpriseRoute() {
  return (
    <div>
      <div>
        <Header />
            ...
            <div className="sm:flex sm:flex-col sm:align-center">
              <div className="relative max-w-7xl mx-auto py-12 sm:py-6 w-full overflow-hidden px-2">
                ...
                <div className="text-center">
                  <h1 className="text-3xl font-extrabold tracking-tight text-gray-800 dark:text-slate-200 sm:text-4xl">MVP to Enterprise</h1>
                  <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-400">No-code, low-code and custom-code.</p>
                </div>
