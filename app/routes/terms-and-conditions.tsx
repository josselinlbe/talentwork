          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:flex-col sm:align-center space-y-4">
              <div className="prose mx-auto text-gray-500">
                ...
                <p>
                  Other than the content you own, under these Terms, Talentwork and/or its licensors own all the intellectual property rights and materials
                ...
                <p>
                  Certain areas of this Website are restricted from being access by you and Talentwork may further restrict access by you to any areas of this
                ...
                <p>
                  ...
                  to display on this Website. By displaying Your Content, you grant Talentwork a non-exclusive, worldwide irrevocable, sub licensable license to
                  use, reproduce, adapt, publish, translate and distribute it in any and all media.
                </p>

                <p>
                  Your Content must be your own and must not be invading any third-party’s rights. Talentwork reserves the right to remove any of Your Content
                ...
                <p>
                  This Website is provided &quot;as is,&quot; with all faults, and Talentwork express no representations or warranties, of any kind related to
                ...
                <p>
                  In no event shall Talentwork, nor any of its officers, directors and employees, shall be held liable for anything arising out of or in any way
                  connected with your use of this Website whether such liability is under contract. Talentwork, including its officers, directors and employees
                ...
                <p>
                  You hereby indemnify to the fullest extent Talentwork from and against any and/or all liabilities, costs, demands, causes of action, damages and
                ...
                <p>
                  Talentwork is permitted to revise these Terms at any time as it sees fit, and by using this Website you are expected to review these Terms on a
                  regular basis.
                </p>
                ...
                <p>
                  The Talentwork is allowed to assign, transfer, and subcontract its rights and/or obligations under these Terms without any notification.
                ...
                <p>
                  These Terms constitute the entire agreement between Talentwork and you in relation to your use of this Website, and supersede all prior
