---
meta:
  title: Quick Start | Tutorials | Learning Center | SaasRock
  description: Get started using the boilerplate with this Quick Start tutorial
headers:
...
<DocBreadcrumb
  items={[
    ...
    },
    {
      title: "Quick Start",
      routePath:
        "/docs/learning-center/tutorials/quick-start",
    },
  ]}
/>
...
- [v0.2.6](https://github.com/AlexandroMtzG/remix-saas-kit/releases/tag/0.2.6)
...
<DocTutorialImage
  ...
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/1.3.png"
/>

💿 1.5. **Switch to Dark Mode** and Select the **Spanish language** from the Navbar items:

<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/1.4.png"
  alt="Dark mode and Spanish Hero"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/2.2.png"
  alt="Admin Dashboard"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/2.3.png"
  alt="Pricing Plans"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/2.4.png"
  alt="Stripe Products"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/2.5.png"
  alt="Pricing"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/3.2.png"
  alt="New Postmark Server"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/3.4.png"
  alt="Domain Verification"
/>

<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/3.4-verified.png"
  alt="Domain Verified"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/3.5.png"
  alt="Email Templates"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/3.6.png"
  alt="Postmark Email Templates"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/4.1-email.png"
  alt="Welcome email"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/4.2.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.1.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.2.png"
  alt="New Member"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.2-email.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.2-setup.png"
  alt="Set up account"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.3.png"
  alt="My Subscription"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.4.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.5.png"
  alt="Upgrade Account"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/5.6.png"
  alt="Audit Trails"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/6.1.png"
  alt="Employees"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/6.2.png"
  alt="New employee"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/6.4.png"
  alt="Edit employee"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/7.1.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/7.2-added.png"
  alt="Added Documents Property"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/7.4-added.png"
  alt="Edited Documents Field"
/>

### 8. Adding Employees to Google Sheets using Webhooks

💿 8.1. As an admin user, go to `/admin/entities/employees/webhooks`.
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.1.png"
  alt="Employee Entity Webhooks"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.2.png"
  alt="Webhooks by Zapier"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.5.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.7.png"
  alt="Test Trigger"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.8.png"
  alt="Google Sheet"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.10.png"
  alt="Google Sheet Fields"
/>

💿 8.11. Finally, add another employee and verify that the webhook is called.

<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/8.11.png"
  alt="Added Employee to Google Sheet"
/>
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/9.1.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/9.2.png"
...
<DocTutorialImage
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/9.5.png"
  alt="Send GET API request"
/>
...
<DocTutorialImage
  alt="New linked account"
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.1.png"
/>

You could also create another account with a valid email to get the following email:

<DocTutorialImage
  alt="Link invitation email"
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.1-email.png"
/>

💿 10.2. Log in as that tenant, and accept the invitation.

<DocTutorialImage
  alt="Accept link invitation"
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.2.png"
/>
...
<DocTutorialImage
  ...
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.3.png"
/>
...
<DocTutorialImage
  alt="Contract Email"
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.3-email.png"
/>
...
<DocTutorialImage
  alt="Dashboard"
  src="https://yahooder.sirv.com/saasrock/tutorials/quick-start-v-0-2-6/10.4.png"
/>

---

I hope this tutorial was useful! [Let me know](/docs/community) if you have any question.
