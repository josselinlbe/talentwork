...
- **Contract** - Has 4 hard-coded properties _(DB model columns)_: _**Name, Description, and File**_.
...
💿 9.6. Test the **POST**, **GET** (/:id), **PUT**, and **DELETE** methods as you might expect them to work.

---

I hope you enjoy the codebase as much as we do!
