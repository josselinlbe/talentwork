---
meta:
  title: Quick Start v0.2.5 | Tutorials | Learning Center | SaasRock
...
<DocBreadcrumb
  items={[
    ...
    },
    {
      title: "Quick Start",
      routePath:
        "/docs/learning-center/tutorials/quick-start-v-0-2-5",
    },
  ]}
/>
...
- [v0.2.5](https://github.com/AlexandroMtzG/remix-saas-kit/releases/tag/0.2.5)
