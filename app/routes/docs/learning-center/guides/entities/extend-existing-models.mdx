---
meta:
  title: Extend Existing Models | Guides | Learning Center | Talentwork
...
💿 Start your app, and add the _JobPost_ **Custom Entity**.
...
💿 For each field, click on **_Show advanced options_** and set **Is dynamic** to `false`.
...
💿 Add the `jobPost` property to the **_includeRowDetails_** constant:
...
💿 Open a new terminal window an run **prisma studio** to browser the **JobPosts** _model/table_ rows.
