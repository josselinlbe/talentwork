---
meta:
  title: Events and Webhooks | Features | Talentwork
...
Talentwork Core 🪨 has 5 built-in **Application** events + internal webhooks:
...
Talentwork Enterprise 🚀 has +40 **Application** events:
...
Talentwork Enterprise 🚀 will have **Admin** events (🚧 under construction) for:
