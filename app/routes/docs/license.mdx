---
meta:
  title: License | SaasRock
  description: SaasRock developer license
headers:
...
**SaasRock** is a _SaaS boilerplate_ that grants you a non-exclusive lifetime license for 1 developer.

As long as you have an active subscription, you'll have access to the private repository for monthly updates.

Subscription's price is [$99/month](https://alexandromg.gumroad.com/l/SaasRock?tier=Core%20Features%20%F0%9F%AA%A8) for the Core features, and [$299/month](https://alexandromg.gumroad.com/l/SaasRock?tier=Enterprise%20Features%20%F0%9F%9A%80) for the Enterprise features that are currently in construction (Workflows, Internationalization, Feature flags, and more).
...
**_Licensee_** is the business entity who has purchased a Team License.

**_SaaS boilerplate_** is the HTML, CSS and JavaScript source code snippets and design assets made available to the _Licensee_ after purchasing a SaasRock license.
...
SaasRock’s liability to you for costs, damages, or other losses arising from your use of the _SaaS boilerplate_ — including third-party claims against you — is limited to a refund of your license fee. SaasRock may not be held liable for any consequential damages related to your use of the _SaaS boilerplate_.
