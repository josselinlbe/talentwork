...
meta:
  ...
  description: SaasRock Individual and Team Licenses
headers:
...
**SaasRock** is a _SaaS boilerplate_ that grants you a non-exclusive license for 1 developer and 1 private repository access for new releases.
...
The only thing that differs from the **Individual License** is that you can share the code with 10 developers.
