...
The subscription's price is [$99/month](https://alexandromg.gumroad.com/l/SaasRock?tier=Core%20Features%20%F0%9F%AA%A8) for the Core features, and [$149/month](https://alexandromg.gumroad.com/l/SaasRock?tier=Enterprise%20Features%20%F0%9F%9A%80) for the Enterprise features that are currently in construction (Workflows, Internationalization, Feature flags, and more).
