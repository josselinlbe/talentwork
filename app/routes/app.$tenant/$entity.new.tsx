...
export let loader: LoaderFunction = async ({ request, params }) => {
  ...
  return json(
    await loaderRowNew({ request, params, tenantId: tenantUrl.tenantId, entitySlug: params.entity ?? "", entityRowsRoute: UrlUtils.currentEntityUrl(params), validateIsAutogenerated: true })
  );
};
