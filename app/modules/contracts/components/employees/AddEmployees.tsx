              ...
              <div>
                <div className="flex items-center justify-between space-x-3">
                  <label htmlFor="file" className="block text-sm font-normal text-gray-700 truncate">
                    {t("app.employees.actions.uploadCsv")} <span className="font-bold italic truncate">{t("app.employees.actions.uploadCsvColumns")}</span>
                  </label>
                  <button
                    type="button"
        ...
        <div className="my-4 flex items-center justify-end space-x-2">
          <div className="flex items-center space-x-2">
            <button
              ...
              type="button"
              className={clsx(
                "inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm sm:text-sm font-medium sm:rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500",
            ...
            <LoadingButton
              ...
              type="submit"
              className={clsx(
                "inline-flex items-center space-x-2 px-3 py-2 border border-transparent shadow-sm sm:text-sm font-medium sm:rounded-md text-white bg-theme-600 hover:bg-theme-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500",
                loading && " opacity-80 cursor-not-allowed"
              )}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
