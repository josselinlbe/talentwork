  ...
  contract.members.forEach(async (member) => {
    await sendEmail(
      ...
      "contract-new",
      {
        ...
        tenant_creator: contract.linkedAccount.createdByTenant.name,
        tenant_provider: contract.linkedAccount.providerTenant.name,
        tenant_client: contract.linkedAccount.clientTenant.name,
