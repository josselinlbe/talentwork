...
- **3 - Optional auth pages**: _invitation link, magic-links… (better UX 😙🤌)_.
- **4 - Should you build your own auth system?** _Yes._
- **5 - Should I use a commercial Auth/Authorization provider?** _No._
- **6 - Let your users test the app** then ask them to register _(😙🤌)_.
...
Every auth system needs at least a [Log-in](https://demo.saasrock.com/login) page, a [Sign-up](https://demo.saasrock.com/register) page, and a [Forgot-password](https://demo.saasrock.com/forgot-password) page.
...
It's better to add **social account integrations** for app features, not app authentication _(eg: after a user signs up, let them connect their Instagram account to load all of their photos)_.
...
If you liked this post, check out [my blog](https://alexandro.dev) for more content like this 😃.
