...
1. <a href="#1-creating-the-boilerplate" className="font-normal no-underline border-b-0">
     Creating the <b className="border-b border-theme-400">Boilerplate</b>
   </a>
2. <a href="#2-migrating-vue2-to-vue3" className="font-normal no-underline border-b-0">
     Migrating Vue2 to <b className="border-b border-theme-400">Vue3</b>
   </a>
3. <a href="#3-migrating-vue3-to-react" className="font-normal no-underline border-b-0">
     Migrating Vue3 to <b className="border-b border-theme-400">React</b>
   </a>
4. <a href="#4-migrating-react-to-svelte" className="font-normal no-underline border-b-0">
     Migrating React to <b className="border-b border-theme-400">Svelte</b>
   </a>
5. <a href="#5-creating-the-documentation" className="font-normal no-underline border-b-0">
     Creating the <b className="border-b border-theme-400">Documentation</b>
   </a>
6. <a href="#6-creating-the-free-ui-components" className="font-normal no-underline border-b-0">
     Creating free UI <b className="border-b border-theme-400">Components</b>
   </a>
7. <a href="#7-creating-the-editions" className="font-normal no-underline border-b-0">
     Creating the <b className="border-b border-theme-400">Editions</b>
   </a>
8. <a href="#8-publishing-demos" className="font-normal no-underline border-b-0">
     Publishing <b className="border-b border-theme-400">Demos</b>
   </a>
9. <a href="#9-publishing-codebases" className="font-normal no-underline border-b-0">
     Publishing <b className="border-b border-theme-400">Codebases</b>
   </a>
10. <a href="#10-publishing-on-gumroad" className="font-normal no-underline border-b-0">
      Publishing on <b className="border-b border-theme-400">Gumroad</b>
    </a>
11. <a href="#11-creating-the-blog" className="font-normal no-underline border-b-0">
      Creating the <b className="border-b border-theme-400">Blog</b>
    </a>
